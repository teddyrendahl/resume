...
%%% Essentials
\name{Teddy.}{Rendahl}
\address{1919 Cooley Ave, Palo Alto, C.A 94303}
\mobile{(+1) 530-574-4792} 
%%% Social
\email{teddy.rendahl@gmail.com}
\github{teddyrendahl}
%%% Optionals
\position{Engineer{\enskip\cdotp\enskip}Python Developer{\enskip\cdotp\enskip}Physicist}
...
\import{\sectiondir}{extracurriculars.tex}
